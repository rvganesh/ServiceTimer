...
public class IntervalSettingActivity extends FragmentActivity{
	...
	private void init(){
		...
		((TextView)findViewById(R.id.txtTitle)).setText(getString(R.string.interval));
	...
	private ArrayList<Item> getItems(){
		...
		IntervalPreferences prefs = new IntervalPreferences(this);
